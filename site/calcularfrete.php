...
if($_POST['qtd']=='0') $qtd = '1'; else $qtd = secure($_POST['qtd']);
...
<div style="width:590px; margin:5px;">
    ...
    <fieldset>
        <h2>Calcule seu frete</h2><hr style="margin-top:-1px;">
        <form action="" method="post" name="cart" id="cart">
            ...
            <input type="text" name="qtd" id="qtd" value="<?php if(!empty($qtd)) echo $qtd; else echo '1'; ?>" class="" style="width:40px; margin-top:-10px;">
            </div>
    ...
    <div class="neutro">
  	...
  	<span style="font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:normal;">* Prazo a partir da confirmação de pagamento, sujeito a alterações</span></div>
</div>
<!-- Fim Calculo Frete -->
