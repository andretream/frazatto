...
<div id="container" class="pt20">
    ...
    <div id="meio">
				...
				<?php if($rowProd['valor'] > '0') {//se tiver valor ?>
                    <?php if($rowProd['valor_promocao']!='0.00') {//valor promocional ?>
                        ...
                        <div class="fd-valor">
							...
							if($maxPar > 0) { 
							?>
                            	<span class="f12">À vista ou <?php echo $maxPar; ?>x de R$ <?php echo decimal($rowProd['valor_promocao'] / $maxPar); ?> no cartão</span>
                        	<?php } ?>
                        </div>
                    ...
                    <?php } else {//valor normal ?>
                        ...
                        <div class="fd-valor">
							...
							if($maxPar > 0) { 
							?>
                            	<span class="f12">À vista ou <?php echo $maxPar; ?>x de R$ <?php echo decimal($rowProd['valor'] / $maxPar); ?> no cartão</span>
                        	<?php } ?>
                        </div>
		...
		FROM produtos, relaciona_produtos_categorias 
		WHERE ativa='S' AND status='S' AND codigo!='".$rowProd['codigo']."' AND rel_cod_cat_principal='".$rowCat['codigo']."' AND rel_cod_pro=codigo 
